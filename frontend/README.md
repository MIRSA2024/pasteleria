...
Aplicación web para la gestión de pedidos de una pastelería (versión DEVELOP), con catálogo de productos, carrito de compras, seguimiento de pedidos y panel de administración para gestionar productos, pedidos y entregas.
